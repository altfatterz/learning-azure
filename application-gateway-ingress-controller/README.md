...
- AGIC is configured via the Kubernetes Ingress resource
- Needs an Application Gateway Instance (Standard_v2 or WAF_v2_SKU)
- Easy to install via an add-on

```bash
RESOURCE_GROUP='agic-demo-rg'
AKS_NAME='agic-demo-aks'
ACR_NAME='agicdemoacr1'
